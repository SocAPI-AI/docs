...
| Mentions | Partial | `GET /mentions` returns only media your account was tagged in. @mentions written inside a caption or a comment are not returned, and do not currently fire `mention.received`. See [Mentions](/guides/inbox#mentions) |
