...
| 400 | `platform.instagram.window_closed`, `platform.facebook.window_closed` | The 24-hour messaging window has closed; the user must message you first to reopen it |
